...
| LocalStack drift from real S3 (especially around policy/lifecycle behavior) | Document known divergences in the ADR. Keep production rollout gated on a manual smoke against a real bucket before public release. |
